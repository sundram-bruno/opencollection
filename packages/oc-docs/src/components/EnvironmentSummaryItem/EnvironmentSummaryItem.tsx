...
export const EnvironmentSummaryItem: React.FC<EnvironmentSummaryItemProps> = ({ environment }) => (
  <EnvironmentSummaryItemWrapper className="environment-summary-item" data-testid="overview-environment-item">
    <span
    ...
    <span className="environment-summary-vars" data-testid="overview-environment-item-variable-count">{formatVariableCount(environment.variables?.length ?? 0)}</span>
